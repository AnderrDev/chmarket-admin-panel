...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const origin = (() => {
      ...
      console.warn('⚠️ No se pudo detectar el origin correcto, usando fallback');
    ...
    let discountRow: { id: string; code: string; discount_percentage: number; discount_amount_cents: number; is_active: boolean } | null = null;

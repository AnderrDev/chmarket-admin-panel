...
-- VIEW: catalog
-- =====================================================
-- Descripción: Vista principal del catálogo con productos y variantes
...
group by p.id, p.slug, p.name, p.description, p.long_description, p.images,
         p.features, p.ingredients, p.nutrition_facts, p.tags, p.is_featured,
         p.is_active, p.store, p.category_id, c.name, p.created_at, p.updated_at;

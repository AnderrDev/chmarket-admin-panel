        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white shadow rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-medium text-gray-900">Estado de la Orden</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium">{formatCurrency(order.subtotal_cents)}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-500">Envío:</span>
                <span className="text-sm font-medium">{formatCurrency(order.shipping_cents)}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-500">Descuento:</span>
                <span className="text-sm font-medium text-red-600">-{formatCurrency(order.discount_cents)}</span>
              </div>
              <div className="border-t pt-3">
                <div className="flex items-center justify-between">
                  <span className="text-lg font-medium text-gray-900">Total:</span>
                  <span className="text-lg font-bold text-gray-900">{formatCurrency(order.total_cents)}</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              {order.payment_provider && (
                <div>
                  ...
                  <div className="text-sm font-medium text-gray-900">{order.payment_provider}</div>
                </div>
              )}
              ...
              {order.payment_id && (
                <div>
                  ...
                  <div className="text-sm font-medium text-gray-900">{order.payment_id}</div>
                </div>
              )}
            </div>
          </div>
